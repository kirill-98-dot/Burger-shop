      ...
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 yellow-gradient rounded-lg flex items-center justify-center">
            <span className="text-primary-foreground font-black text-xl">В</span>
          </div>
          <div>
            <h1 className="text-xl font-bold text-foreground">ВЕКТОР</h1>
            <p className="text-xs text-muted-foreground">Автошкола</p>
          </div>
        </div>
